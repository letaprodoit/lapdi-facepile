...
class TSP_Easy_Plugin_Settings_Facepile extends TSP_Easy_Plugin_Settings
{
	...
	function display_plugin_settings_page() 
	{
		...
		$defaults = new TSP_Easy_Plugin_Globals ( get_option( $this->plugin_globals['option_name'] ) );
		    ...
		    foreach ($fields as $key => $val)
		    {
	       	...
	       	{ 
				...
				{ 		        
					...
					$display_gravatar = get_avatar($curauth->user_email, $thumb_size, $gravatar_type, $name); //get avatar
