...
* `[tsp-facepile title="Facepile" shownames="Y" num_rows="4" num_cols="4" widththumb="80" heightthumb="80" beforetitle="" aftertitle=""]` - Will override all attributes defined on the plugin's settings page.
